...
const translations = {
  ...
  fr: {
    ...
    home1: "Salut je suis",
    home2:
      "et je suis <span class='highlight-color'>Frontend Developper</span>",
...
function handleSwitchButtonClick() {
  ...
  // Pour cet exemple, je vais utiliser une variable pour représenter la langue actuelle.

  let currentLanguage = document.documentElement; // français par défaut

  // Si la langue actuelle est l'anglais, on passe au français. Sinon, on repasse à l'anglais.
  if (currentLanguage.lang === "fr") {
    switchLanguage("en");
    currentLanguage.setAttribute("lang", "en");
    flag.innerHTML = `<?xml version="1.0" encoding="utf-8"?>
    <svg
      viewBox="0 0 36 36"
